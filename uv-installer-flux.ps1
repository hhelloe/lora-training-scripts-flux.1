...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://ghfast.top/https://github.com/astral-sh/uv/releases/download/0.8.18',
...
if ($env:UV_INSTALLER_GHE_BASE_URL) {
  ...
  $installer_base_url = "https://ghfast.top/https://github.com"
}
