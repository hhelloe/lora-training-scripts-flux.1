...
$pretrained_model = "./Stable-diffusion/sd3.5_medium.safetensors" # base model path | 底模路径
$vae = ""
...
$sigma_max_scale = 1.1 # sigma max scale | sigma 最大缩放
...
$max_train_epoches = 80 # max train epoches | 最大训练 epoch
$save_every_n_epochs = 20 # save every n epochs | 每 N 个 epoch 保存一次
...
$output_name = "sd35m-test-db-1e-4" # output model name | 模型保存名称
