...
#训练模式(Lora、db、sdxl_lora、Sdxl_db、sdxl_cn3l、stable_cascade_db、stable_cascade_lora、controlnet、hunyuan_lora、hunyuan_db、sd3_db)
$train_mode = "sdxl_controlnet"

# Train data path | 设置训练用模型、图片
$pretrained_model = "./Stable-diffusion/SDXL/sdxl10ArienmixxlAsian_v40Pruned.safetensors" # base model path | 底模路径
...
$output_name = "controlnetl_sdxl_dwpose_v2" # output model name | 模型保存名称
$save_model_as = "safetensors" # model save ext | 模型保存格式 ckpt, pt, safetensors
$mixed_precision = "fp16" # 默认fp16,no,bf16可选
$save_precision = "fp16" # 默认fp16,fp32,bf16可选
$full_fp16 = 1 #开启全fp16模式，自动混合精度变为fp16，更节约显存
...
$sample_prompts = "./toml/controlnet_sdxl.txt" #prompt文件路径
