...
$use_rating_tags = 0 #使用分类标签
$use_rating_tags_as_last_tag = 0 #分类标签放最后
$character_tags_first = 0 #角色标签放在前面
$character_tag_expand = 0 #人物 系列拆分，chara_name_(series) 变为 chara_name, series.
$always_first_tags = "1girl,1boy,2girls,3girls,4girls,5girls,6girls,2boys,3boys,4boys,5boys,6boys" #指定标签放最前，当图像中出现某个标签时，总是先输出该标签。可以指定多个标签，以逗号分隔
