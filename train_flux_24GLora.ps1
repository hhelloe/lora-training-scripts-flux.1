...
$pretrained_model = "./Stable-diffusion/flux/flux1-dev2pro.safetensors" # base model path | 底模路径
$vae = "./VAE/ae.sft"
...
#SD3 训练相关参数
$clip_l = "./clip/ViT-L-14-TEXT-detail-improved-hiT-GmP-TE-only-HF.safetensors"
...
$max_train_epoches = 60 # max train epoches | 最大训练 epoch
...
$output_name = "flux-test-lora-1e-6" # output model name | 模型保存名称
